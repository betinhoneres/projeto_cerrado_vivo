	...
	<body>
		...
		<div id="show-cidade" class="content scaffold-show" role="main">
			...
			<ol class="property-list cidade">
				...
				<li class="fieldcontain">
					<span id="uf-label" class="property-label"><g:message code="cidade.uf.label" default="Uf" /></span>
					
						<span class="property-value" aria-labelledby="uf-label"><g:fieldValue bean="${cidadeInstance}" field="uf"/></span>
